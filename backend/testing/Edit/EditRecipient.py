...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_xpath(
            "//div[@id='root']/div/div/div[2]/div[2]/table/tbody/tr/td[5]/a[2]"
        ).click()
        ...
        driver.find_element_by_xpath(
            "//div[@id='formGridCheckbox']/div[6]/label"
        ).click()
        ...
        driver.find_element_by_xpath(
            "//div[@id='root']/div/div/div/form/button"
        ).click()
        driver.find_element_by_xpath(
            "//div[@id='root']/div/div/div/form/a/button"
        ).click()
        driver.find_element_by_xpath(
            "//div[@id='root']/div/div/div[2]/div[2]/table/tbody/tr/td[5]/a"
        ).click()
