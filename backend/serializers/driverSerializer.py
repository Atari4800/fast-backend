...
class DriverSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.employee_status = validated_data.get(
            "employee_status", instance.employee_status
        )
        instance.phone = validated_data.get("phone", instance.phone)
        instance.duration = validated_data.get("duration", instance.duration)
        instance.delivery_limit = validated_data.get(
            "delivery_limit", instance.delivery_limit
        )
        ...
        availability.wednesday = availability_data.get(
